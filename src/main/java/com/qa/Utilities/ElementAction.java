...
public class ElementAction extends DriverCalling{
	...
	public void selectDDByText(WebElement ele,String text)
	{
		try
		{
			...
			Extent_Reporting.Log_Message("Drop down option with visible text "+text+" is selected", test, driver);
			}
			else
			{
				throw new Exception();
	...
	public void selectDDByIndex(WebElement ele,int Index)
	{
		try
		{
			...
			Extent_Reporting.Log_Message("Drop down option at the position "+Index+" is selected", test, driver);
			}
			else
			{
				throw new Exception();
	...
	public void deselectDDByText(WebElement ele,String text)
	{
		try
		{
			...
			Extent_Reporting.Log_Message("Drop down option with visible text "+text+" is deselected", test, driver);
			}
			else
			{
				throw new Exception();
	...
	public void deselectDDByIndex(WebElement ele,int Index)
	{
		try
		{
			...
			Select selectEle=new Select(ele);
			selectEle.selectByIndex(Index);
			Extent_Reporting.Log_Message("Drop down option at the position "+Index+" is deselected", test, driver);
			}
			else
			{
				throw new Exception();
	...
	public  boolean WaitUntilDisplayed(WebElement ele)
	{
		...
		try
		{
			...
			for(int i=0;i<5;i++)
			{
				...
				{
					status=true;
					//Extent_Reporting.Log_Message("Wait successful Element is displayed", test,driver);
					//break;
				}
				else
				{
	...
	public  boolean isElementEnabled(WebElement ele, String name)
	{
		boolean status=false;
		Scroll(ele);
		 	try
